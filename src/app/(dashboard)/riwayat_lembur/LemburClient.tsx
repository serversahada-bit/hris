                  ...
                  <tr key={r.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 text-center">
                      <div className="flex flex-col items-center gap-1">
                        ...
                        {mgrSt === "REJECTED" && r.manager_notes && (
                          <span title={r.manager_notes} className="max-w-[180px] truncate text-[11px] text-rose-500 font-semibold italic">
                            M: &ldquo;{r.manager_notes}&rdquo;
                          </span>
                        )}
                        {finalSt === "REJECTED" && r.notes && (
                          <span title={r.notes} className="max-w-[180px] truncate text-[11px] text-rose-500 font-semibold italic">
                            HC: &ldquo;{r.notes}&rdquo;
                          </span>
                        )}
                      </div>
                    </td>
