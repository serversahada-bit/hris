                  ...
                  <tr key={row.id} className="hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors">
                    ...
                    <td className="px-6 py-4 text-center">
                      <div className="flex flex-col items-center gap-1">
                        ...
                        {row.status === "Ditolak" && row.catatan_admin && (
                          <span
                            title={row.catatan_admin}
                            className="max-w-[180px] truncate text-[11px] text-rose-500 dark:text-rose-400 font-semibold italic"
                          >
                            &ldquo;{row.catatan_admin}&rdquo;
                          </span>
                        )}
                      </div>
                    </td>
                    <td className="px-6 py-4 text-center">
                      <div className="flex flex-col items-center gap-1">
                        ...
                        {row.manager_status === "Ditolak" && row.manager_note && (
                          <span
                            title={row.manager_note}
                            className="max-w-[180px] truncate text-[11px] text-rose-500 dark:text-rose-400 font-semibold italic"
                          >
                            &ldquo;{row.manager_note}&rdquo;
                          </span>
                        )}
                      </div>
                    </td>
